...
/**
 * <p>
 * Object reference context interface used by {@link SharedReferenceSerializer}
 * to resolve multi-referenced instances, annotated with {@link SharedReference}.
 * IDs are short values in order to minimize the serialization size.
 * <p>
...
public interface ReferenceContext {
	...
	/**
	 * Used when serializing an object's field annotated with {@link SharedReference}
	 * 
	 * @param o
